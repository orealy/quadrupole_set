...
(define create_barrier (lambda ()
  ...
  (define left_barrier_center_x (+ barrier_sep barrier_width))
  ...
  (define corner_a_x (/ barrier_width -2))
  (define corner_a_y (+ (/ top_gate_width 2) barrier_overhang))
  (define corner_a_z 0)

  ; bottom right corner, top size
  (define corner_b_x (/ barrier_width 2))
  (define corner_b_y extend_far)
